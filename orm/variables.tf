...
variable "mds_instance_name" {
  ...
  default     = "MagentoMDS_with_HeatWave"
}
...
variable "mysql_db_system_description" {
  description = "MySQL DB System for Magento-MDS with HeatWave"
  default = "MySQL DB System for Magento-MDS with HeatWave"
}
